# feeds.py — Indianapolis Colts (trusted feeds + rich buttons)

TEAM_NAME = "Indianapolis Colts Football"
TEAM_SLUG = "indianapolis-colts"

# Optional theme colors for your CSS (can be ignored by the frontend)
TEAM_COLORS = {"primary": "#003A70", "secondary": "#FFFFFF", "text": "#111111"}

# Help aggregators match the right team
TEAM_KEYWORDS = [
...
# Keep football context on broad feeds
SPORT_TOKENS = ["NFL", "football", "National Football League", "Colts"]

# Avoid obvious non-Colts noise (do NOT exclude opponents or you’ll lose game stories)
EXCLUDE_TOKENS = [
...
# IMPORTANT: trusted=True bypasses keyword filters entirely (so the site is never empty)
FEEDS = [
    ...
    {"name": "SI — Horseshoe Huddle",            "url": "https://www.si.com/nfl/colts/.rss",                                       "trusted": True},

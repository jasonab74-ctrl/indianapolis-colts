# feeds.py — Indianapolis Colts (final, reliable)

TEAM_NAME = "Indianapolis Colts Football"
TEAM_SLUG = "indianapolis-colts"

# Used only by your CSS theme
...
# Helps keep “football” context on aggregators
SPORT_TOKENS = ["NFL", "football", "National Football League", "Colts"]

# Keep exclusions tight (do NOT exclude opponents; that filters game stories)
EXCLUDE_TOKENS = [
...
# IMPORTANT: trusted=True bypasses filtering completely
FEEDS = [
    # Official / high-signal (trusted)
    ...
    {"name": "Sports Illustrated — Horseshoe",   "url": "https://www.si.com/nfl/colts/.rss",                                       "trusted": True},
    ...
    {"name": "ESPN Colts (team page news)",     "url": "https://www.espn.com/espn/rss/nfl/news",                                   "trusted": False},  # ESPN lacks stable team RSS
    ...
    {"name": "\"Indianapolis Colts\" — Google News",
     "url": "https://news.google.com/rss/search?q=%22Indianapolis+Colts%22&hl=en-US&gl=US&ceid=US:en", "trusted": False},
    {"name": "Bing News — Indianapolis Colts",
     "url": "https://www.bing.com/news/search?q=Indianapolis+Colts&format=rss", "trusted": False},
]

# Buttons row (Rams-style richness)
STATIC_LINKS = [

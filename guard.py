#!/usr/bin/env python3
# Guard runner — prevents regressions while still auto-updating (Colts)
...
ALLOWED_SOURCES = {
    "Colts.com","IndyStar","Stampede Blue","Colts Wire",
    "WTHR","WISH-TV","CBS4Indy","ESPN","Yahoo Sports","Sports Illustrated",
}
